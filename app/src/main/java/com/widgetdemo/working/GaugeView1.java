 ...
 */
public class GaugeView1 extends View {
    ...
    public GaugeView1(Context context, AttributeSet attrs) {
...
//        canvas.drawArc(rectfInner, 225, sweepAngleSecondChart, false, paintInnerArc1);

        int sweepingangle = (int)(360 * (percentvalue/100));
        canvas.drawArc(rectfInner, 0, 360, false, paintInnerArc2);
...
//        canvas.drawArc(rectfInner, 315, sweepAngleThirdChart, false, paintInnerArc3);
        canvas.drawArc(rectfInner, 315, sweepAngleThirdChart, false, paintInnerArc1);
