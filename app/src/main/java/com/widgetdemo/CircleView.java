...
/*    float radius;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float guageWidth = radius * 0.0856f;
...
//        canvas.drawText(rotatedtext,px + guageWidth, py, paint);
            ...
            /*if(scaleAngle < 270) {
//                canvas.rotate( 90, px + rect.exactCenterX(), py + rect.exactCenterY());
                canvas.drawText(rotatedtext, px + rect.exactCenterX() , py + rect.exactCenterY(), paint);
            }else{
//                canvas.rotate( 90, px - rect.exactCenterX(), py - rect.exactCenterY());
                canvas.drawText(rotatedtext, px - rect.exactCenterX() , py - rect.exactCenterY(), paint);
            }*/

//            rotating_angle = (int) (rotating_angle + (scaleAngle + 90));
